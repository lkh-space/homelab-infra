...
| **개별 서비스 상세 스펙 및 런북** | [`.agents/references/services/`](file:///Users/limkeunhyeok/workspace/homelab-infra/.agents/references/services/) 하위 문서<br>- [`postgres.md`](file:///Users/limkeunhyeok/workspace/homelab-infra/.agents/references/services/postgres.md)<br>- [`mongo.md`](file:///Users/limkeunhyeok/workspace/homelab-infra/.agents/references/services/mongo.md)<br>- [`minio.md`](file:///Users/limkeunhyeok/workspace/homelab-infra/.agents/references/services/minio.md)<br>- [`opensearch.md`](file:///Users/limkeunhyeok/workspace/homelab-infra/.agents/references/services/opensearch.md)<br>- [`rabbitmq.md`](file:///Users/limkeunhyeok/workspace/homelab-infra/.agents/references/services/rabbitmq.md)<br>- [`redis.md`](file:///Users/limkeunhyeok/workspace/homelab-infra/.agents/references/services/redis.md)<br>- [`authelia.md`](file:///Users/limkeunhyeok/workspace/homelab-infra/.agents/references/services/authelia.md)<br>- [`argocd.md`](file:///Users/limkeunhyeok/workspace/homelab-infra/.agents/references/services/argocd.md) | 개별 서비스의 환경변수 스키마, 볼륨 마운트 경로, 헬스체크 명령, 포트포워딩 및 운영 런북 |
...
| **비밀번호 변경 및 보안 로테이션** | [`.agents/references/password-rotation.md`](file:///Users/limkeunhyeok/workspace/homelab-infra/.agents/references/password-rotation.md) | 7대 인프라 서비스별 개별/일괄 비밀번호 안전 교체 런북, 연계 재기동 및 검증 절차 |
